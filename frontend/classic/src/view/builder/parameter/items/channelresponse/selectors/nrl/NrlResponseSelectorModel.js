...
Ext.define('yasmine.view.xml.builder.parameter.items.channelresponse.nrlselector.NrlResponseSelectorModel', {
  extend: 'Ext.app.ViewModel',
  alias: 'viewmodel.nrl-response-selector',
  data: {
...
Ext.define('yasmine.view.xml.builder.parameter.items.channelresponse.nrllselector.Response', {
